...
import PageBangThongKe from "../containers/User/PageBangThongKe/listPagethongke";
...
import FromUpdateProject from "../containers/Admin/Project/DetailProject/UpdateProject/FromUpdateProject";
const publicRouter = [
    {
        path: "/",
        component: Home,
...
const AdminRoute = [
    ...
    {
        path: "/quan-ly-chi-tiet-bao-cao/sua-du-an:idWork",
        component: FromUpdateProject,
    },
    {
